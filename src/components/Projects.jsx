  ...
  const projects = [
    {
      ...
      title: "CloudKitchen",
      description:
        "Frontend for a cloud kitchen platform built withReact. Organized menu, interactive UI, clean design. Responsive design coming soon.",
      image: Kitchen,
    ...
    },
    {
      ...
      image:
        "https://via.placeholder.com/400x300/f3f4f6/6b7280?text=Hotel+Booking",
      tech: ["React", "Tailwind"],
    ...
    },
    {
      ...
      title: "MediBox",
      description:
        "Web-based MediBox platform built with React. Users can browse, search, and manage medical products, and access virtual consultations through a clean and interactive interface.",
      image:
        "https://via.placeholder.com/400x300/f3f4f6/6b7280?text=MediBox",
    ...
    },
    {
      ...
      image:
        "https://via.placeholder.com/400x300/f3f4f6/6b7280?text=Car+Selling",
    ...
    },
    {
      ...
      image:
        "https://via.placeholder.com/400x300/f3f4f6/6b7280?text=Movie+Platform",
  ...
  return (
    <section className="py-20 px-4 md:px-8 lg:px-16 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="overflow-hidden w-full brutalist-border brutalist-shadow bg-white py-4">
          <div className="flex gap-8 animate-marquee" style={{ whiteSpace: "nowrap" }}>
            {projects.concat(projects).map((project, idx) => (
              <div
                key={project.id + "-" + idx}
                className="group relative brutalist-border brutalist-shadow brutalist-hover-lift bg-white overflow-hidden w-[350px] flex-shrink-0"
              >
                <div className="relative overflow-hidden aspect-video bg-white">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-80 transition-all duration-300 flex items-center justify-center">
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center text-white p-6 w-full">
                      <h3 className="brutalist-heading text-2xl mb-4">
                        {project.title}
                      </h3>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 text-xs font-semibold brutalist-border bg-gray-100"
                      >
                        {tech}
                      </span>
                    ))}
